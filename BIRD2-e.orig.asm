\ Disassembly of Bird Strike from Mr Spock's cracked disc
\ 
\ 
\ 
\
...
.t1
        ...
        INC     no
        INC     no
        JSR     L1326     \ Doesn't exist in B version
        JMP     t1
...
.BeebDisEndAddr
SAVE "BIRD2-e.orig.bin",BeebDisStartAddr,BeebDisEndAddr
